...
class App extends React.Component {
  ...
  render() {
    return (
      ...
      {this.state.view === 'home' && <Homepage loginVal={this.loginVal} submit={this.loginSubmitButton}goProfile={this.goProfile} land={this.goLanding} user={this.state.user} changeUser={this.changeUser} userErr={this.state.userErr} loginButton={this.loginButton} login={this.state.loginModal} exit={this.exitModal}/>}
